...
module.exports = function(tilelive, options) {
  ...
  var getTile = function(z, x, y, scale, format, callback) {
    ...
    var sourceMaxZoom = 14;
    while(params.tile.sourceMaxZoom > sourceMaxZoom) {
      params.tile.sourceMaxZoom--;
      params.tile.sourceMaxZoomX = Math.floor(params.tile.sourceMaxZoomX/2);
      params.tile.sourceMaxZoomY = Math.floor(params.tile.sourceMaxZoomY/2);
    }
